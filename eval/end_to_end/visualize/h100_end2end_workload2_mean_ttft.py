...
pp = pd.DataFrame.from_dict(load_results("../results-0413-2-H100/pp"))
tp = pd.DataFrame.from_dict(load_results("../results-0413-2-H100/tp"))
...
fig.tight_layout()
fig.savefig("figures/h100_end2end_workload2_mean_ttft.pdf", bbox_inches="tight")
