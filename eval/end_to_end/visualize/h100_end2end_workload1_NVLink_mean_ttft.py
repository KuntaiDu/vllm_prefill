...
pp = pd.DataFrame.from_dict(load_results("../results-0414-1-H100-NVLink/pp"))
tp = pd.DataFrame.from_dict(load_results("../results-0414-1-H100-NVLink/tp"))

prefill = prefill[prefill.qps != float("inf")]
chunked = chunked[chunked.qps != float("inf")]
pp = pp[pp.qps != float("inf")]
tp = tp[tp.qps != float("inf")]
...
fig.tight_layout()
fig.savefig("figures/h100_end2end_workload1_NVLink_mean_ttft.pdf", bbox_inches="tight")
